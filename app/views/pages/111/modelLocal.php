...
<section id="header">
    <div class="container headContainer">  
                        ...
                        <div class="navWrap">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-plus"></span></a>
								   <ul class="dropdown-menu">
										  <li><a href="modelPhotos.php"><span class="glyphicon glyphicon-camera"></span><b class="caret"></b>Photos</a></li>
										  <li><a href="modelvideos.php"><span class="glyphicon glyphicon-facetime-video"></span><b class="caret"></b>Videos</a></li>
							    ...
							    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span></a>
								   <ul class="dropdown-menu">
										  ...
										  <li class="active"><a href="modelLocal.php">Local</a></li>
		...
		<section id="main">
			<div class="container">
				<h1><p style="text-align:center">Las Vegas</p></h1>
				<br>
				<h1>HELLO</h1>
				<br>
				<h1>HELLO</h1>
