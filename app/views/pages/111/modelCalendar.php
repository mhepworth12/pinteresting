									...
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-plus"></span></a>
										   <ul class="dropdown-menu">
	 								          ...
	 								          <li class="active"><a href="#"><span class="glyphicon glyphicon-calendar"></span><b class="caret"></b>Calendar</a></li>
		...
		<div class="container">
			<section id="calendar">
				<div class="col-md-6" style="color:#000">
					<h1>eCalendar</h1>
					<h2><p>Because your desired rate adjusts like a stock, shouldn't your technology?</p></h2>
				</div> 
			</section>	  
		</div>
